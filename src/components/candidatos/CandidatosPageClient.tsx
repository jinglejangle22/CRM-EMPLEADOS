  ...
  return (
    <div className="mx-auto flex w-full max-w-[950px] flex-col gap-3 px-4 pt-4">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-neutral-900">Candidatos</h1>
        <span className="flex min-h-7 items-center gap-1 rounded-full bg-violet-50 px-3 text-[13px] font-semibold text-violet-700">
      ...
      <div className="grid grid-cols-1 gap-3 pb-4 md:grid-cols-2 xl:grid-cols-3">
        {filtered.length === 0 && (
          <p className="col-span-full py-10 text-center text-sm text-neutral-400">No hay candidatos para este filtro.</p>
        )}
