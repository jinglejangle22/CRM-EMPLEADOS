  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span className="flex size-11 shrink-0 items-center justify-center rounded-full bg-violet-100 text-sm font-semibold text-violet-700">
        ...
        <div className="min-w-0 flex-1">
          ...
          <RatingStars rating={candidate.rating} className="mt-1" />
        </div>
